...
<body>
	...
	<div class="container">
		<div class="box">
			<div class="bigbox">
				<div>
					<img src="/images/instafont.png" alt="x" class="image">
				</div>
				<br />
				...
				<form action="/image/uploadProc" method="post" enctype="multipart/form-data">
					<table class="table">
						<tr>
							<td><input id="input_img" type="file" name="file" placeholder="사진파일" required="required"></td>
						</tr>
						<tr>
							<td>
								<div class="img_wrap">
						...
						<tr>
							<td><input type="hidden" name="userid" value="<%= session.getAttribute("userID")%>"></td>
						</tr>
					</table>
